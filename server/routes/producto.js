...
app.get('/productos/buscar/:termino', validarToken, (req, res) => {
...
// ===========================
app.get('/productos/:id', validarToken, (req, res) => {
    // populate: usuario categoria
    // paginado
...
// ===========================
app.put('/productos/:id', validarToken, (req, res) => {
    // grabar el usuario
    // grabar una categoria del listado 
...
//  Borrar un producto
// ===========================
app.delete('/productos/:id', validarToken, (req, res) => {
